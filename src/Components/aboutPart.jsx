...
export const AboutSide = () =>{
    return(
        ...
        <div className="mx-36 flex flex-col my-6 w-6/12">
            ...
            <p className="group text-[#f5f5f5] text-xl my-6 leading-10 font-open pl-6 text-justify tracking-wide hover:cursor-pointer">
